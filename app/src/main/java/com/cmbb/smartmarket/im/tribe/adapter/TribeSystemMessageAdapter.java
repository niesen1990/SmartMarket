package com.cmbb.smartmarket.im.tribe.adapter;
...
public class TribeSystemMessageAdapter extends YWAsyncBaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.im_system_message_item, parent, false);
        ...
        if (mMessageList != null) {
            ...
            final YWTribe tribe = IMLoginHelper.getInstance().getIMKit().getTribeService().getTribe(tid);
