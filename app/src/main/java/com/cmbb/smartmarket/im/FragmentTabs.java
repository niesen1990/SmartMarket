...
import com.cmbb.smartmarket.im.custom.CustomConversationHelper;
import com.cmbb.smartmarket.im.tribe.TribeConstants;
import com.cmbb.smartmarket.im.tribe.TribeFragment;
...
public class FragmentTabs extends BaseActivity {
    ...
    protected int getLayoutId() {
        return R.layout.im_fragment_tabs;
    }
    ...
    private View getIndicatorView(String tab) {
        View tabView = View.inflate(this, R.layout.im_tab_item, null);
        TextView indicator = (TextView) tabView.findViewById(R.id.tab_text);
        Drawable drawable;

        if (tab.equals(TAB_MESSAGE)) {
            indicator.setText("消息");
            drawable = getResources().getDrawable(R.drawable.im_tab_icon_message_normal);
            ...
            drawable = getResources().getDrawable(R.drawable.im_tab_icon_contact_normal);
            drawable.setBounds(0, 0, drawable.getIntrinsicWidth(),
                    drawable.getIntrinsicHeight());
            indicator.setCompoundDrawables(null, drawable, null, null);
            ...
            drawable = getResources().getDrawable(R.drawable.im_tab_icon_tribe_normal);
            drawable.setBounds(0, 0, drawable.getIntrinsicWidth(),
                    drawable.getIntrinsicHeight());
            indicator.setCompoundDrawables(null, drawable, null, null);
            mTribeTab = indicator;
            ...
            drawable = getResources().getDrawable(R.drawable.im_tab_icon_setting_normal);
            drawable.setBounds(0, 0, drawable.getIntrinsicWidth(),
                    drawable.getIntrinsicHeight());
            indicator.setCompoundDrawables(null, drawable, null, null);
            mMoreTab = indicator;
        ...
        mConversationUnreadChangeListener = new IYWConversationUnreadChangeListener() {
            ...
            public void onUnreadChange() {
                mHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        IMLoginHelper loginHelper = IMLoginHelper.getInstance();
    ...
    private void addTribeChangeListener() {
        mTribeChangedListener = new IYWTribeChangeListener() {
            ...
            public void onInvite(YWTribe tribe, YWTribeMember user) {
                ...
                map.put(tribe, user);
                IMLoginHelper.getInstance().getTribeInviteMessages().add(map);
        ...
        if (isSelected) {
            ...
            if (mMessagePressed == null) {
                mMessagePressed = getResources().getDrawable(
                        R.drawable.im_tab_icon_message_pressed);
            }
            ...
            if (mMessageNormal == null) {
                mMessageNormal = getResources().getDrawable(
                        R.drawable.im_tab_icon_message_normal);
            }
        ...
        if (isSelected) {
            ...
            if (mFriendPressed == null) {
                mFriendPressed = getResources().getDrawable(
                        R.drawable.im_tab_icon_contact_pressed);
            }
            ...
            if (mFriendNormal == null) {
                mFriendNormal = getResources().getDrawable(
                        R.drawable.im_tab_icon_contact_normal);
            }
        ...
        if (isSelected) {
            ...
            if (mTribePressed == null) {
                mTribePressed = getResources().getDrawable(
                        R.drawable.im_tab_icon_tribe_pressed);
            }
            ...
            if (mTribeNormal == null) {
                mTribeNormal = getResources().getDrawable(
                        R.drawable.im_tab_icon_tribe_normal);
            }
        ...
        if (isSelected) {
            ...
            if (mMorePressed == null) {
                mMorePressed = getResources().getDrawable(
                        R.drawable.im_tab_icon_setting_pressed);
            }
            ...
            if (mMoreNormal == null) {
                mMoreNormal = getResources().getDrawable(
                        R.drawable.im_tab_icon_setting_normal);
            }
