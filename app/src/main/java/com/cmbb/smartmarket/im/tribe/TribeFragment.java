...
import com.cmbb.smartmarket.im.core.TribeHelper;
import com.cmbb.smartmarket.im.tribe.adapter.TribeAdapter;
import com.cmbb.smartmarket.im.tribe.model.TribeAndRoomList;
...
public class TribeFragment extends Fragment implements AdapterView.OnItemClickListener, AbsListView.OnScrollListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.im_fragment_tribe, container, false);
...
//        mPullToRefreshListView.resetHeadLayout();
    ...
    private void showPopupMenu(View v) {
        final View bgView = View.inflate(BaseApplication.getContext(), R.layout.im_popup_window_bg, null);
        ...
        View view = View.inflate(BaseApplication.getContext(), R.layout.im_popup_menu, null);
        //创建群组
