...
public class ContactsOperationCustom extends IMContactsOperation {
    ...
    public boolean onListItemClick(Fragment fragment, IYWContact contact) {
        if (contact.getAppKey().equals(YWConstants.YWSDKAppKey)) {
            ...
            Intent intent = IMLoginHelper.getInstance().getIMKit().getChattingActivityIntent(eServiceContact);
            if (intent != null)
                fragment.getActivity().startActivity(intent);
        } else {
            Intent intent = IMLoginHelper.getInstance().getIMKit().getChattingActivityIntent(contact.getUserId(), contact.getAppKey());
            if (intent != null)
                fragment.getActivity().startActivity(intent);
        }
        return true;
    ...
    public boolean onListItemLongClick(Fragment fragment, final IYWContact contact) {
        ...
        final IYWContactService contactService = IMLoginHelper.getInstance().getIMKit().getContactService();
