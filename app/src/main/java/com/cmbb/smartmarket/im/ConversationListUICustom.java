 ...
 * AdviceBinder.bindAdvice(PointCutEnum.CONVERSATION_FRAGMENT_POINTCUT, CustomChattingAdviceim.class);
 *
 * @author jing.huai
 */
public class ConversationListUICustom extends IMConversationListUI {
    ...
    public View getCustomConversationListTitle(final Fragment fragment,
        ...
        RelativeLayout customView = (RelativeLayout) inflater
                .inflate(R.layout.im_custom_conversation_title_bar, new RelativeLayout(context),false);
        ...
        final String loginUserId = IMLoginHelper.getInstance().getIMKit().getIMCore().getLoginUserId();
        final String appKey = IMLoginHelper.getInstance().getIMKit().getIMCore().getAppKey();
    ...
    public View getCustomView(Context context, YWConversation conversation, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView = inflater.inflate(R.layout.im_conversation_custom_view_item,
                    parent,
                    false);
    ...
    public View getCustomItemView(Fragment fragment, YWConversation conversation, View convertView, int viewType, YWContactHeadLoadHelper headLoadHelper, ViewGroup parent) {
        ...
        if (viewType == type_1){
            ...
            if (convertView == null){
                ...
                convertView = inflater.inflate(R.layout.im_custom_conversation_item_2, parent, false);
                holder.head = (ImageView) convertView.findViewById(R.id.head);
                holder.unread = (TextView) convertView.findViewById(R.id.unread);
                holder.name = (TextView) convertView.findViewById(R.id.name);
