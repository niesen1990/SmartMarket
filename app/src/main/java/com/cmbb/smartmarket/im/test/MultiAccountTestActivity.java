 ...
 */
public class MultiAccountTestActivity extends BaseActivity {
    ...
    protected int getLayoutId() {
        return R.layout.im_multi_account_test;
    }
    ...
    AdapterView.OnItemSelectedListener listener = new AdapterView.OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            IMLoginHelper.getInstance().setIMKit(mIMKit);
        }
...
//        startActivity(intent);
    ...
    private void initTest() {
        ...
        testInit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                YWTrackUtil.init(IMLoginHelper.getInstance().getIMKit().getIMCore().getLoginUserId(), IMLoginHelper.APP_KEY, null);
            }
        });
        ...
        test3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = IMLoginHelper.getInstance().getIMKit().getChattingActivityIntent(contact);
                startActivity(intent);
            }
        });
    }
