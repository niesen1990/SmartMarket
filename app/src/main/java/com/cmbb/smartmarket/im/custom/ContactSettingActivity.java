...
public class ContactSettingActivity extends BaseActivity {
    ...
    private Switch msgRemindSwitch;
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        contactManager = (YWContactManager) IMLoginHelper.getInstance().getIMKit().getContactService();
        contact = contactManager.getWXIMContact(appKey, userId);
        conversationService = IMLoginHelper.getInstance().getIMKit().getConversationService();
    ...
    private void initViews() {
        ...
        msgRemindSwitch = (Switch) findViewById(R.id.receive_msg_remind_switch);
        ...
        msgRemindSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
