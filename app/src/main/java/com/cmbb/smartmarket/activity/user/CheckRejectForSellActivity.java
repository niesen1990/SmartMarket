 ...
 * 修改备注：
 */
public class CheckRejectForSellActivity extends BaseActivity {
    private static final String TAG = CheckRejectForSellActivity.class.getSimpleName();
    ...
    public static void newIntent(Context context, MarketOrderListResponseModel.DataEntity.ContentEntity entity) {
        Intent intent = new Intent(context, CheckRejectForSellActivity.class);
