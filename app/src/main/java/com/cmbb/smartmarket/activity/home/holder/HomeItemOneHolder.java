 ...
 */
public class HomeItemOneHolder extends BaseViewHolder<ProductGetPageResponseModel.DataEntity.ContentEntity> {
    private final String TAG = HomeItemOneHolder.class.getSimpleName();
    ...
    public HomeItemOneHolder(ViewGroup parent) {
