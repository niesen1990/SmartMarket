 ...
 */
public class PublishNeedListItemOneHolder extends BaseViewHolder<MyselfProductPublicListResponseModel.DataEntity.ContentEntity> {
    private final String TAG = PublishNeedListItemOneHolder.class.getSimpleName();
    ...
    public PublishNeedListItemOneHolder(ViewGroup parent) {
