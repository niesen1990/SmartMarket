 ...
 */
public class HomeItemTwoHolder extends BaseViewHolder<ProductGetPageResponseModel.DataEntity.ContentEntity> {
    private final String TAG = HomeItemTwoHolder.class.getSimpleName();
    ...
    public HomeItemTwoHolder(ViewGroup parent) {
