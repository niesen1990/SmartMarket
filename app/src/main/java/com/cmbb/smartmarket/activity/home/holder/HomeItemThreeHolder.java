 ...
 */
public class HomeItemThreeHolder extends BaseViewHolder<ProductGetPageResponseModel.DataEntity.ContentEntity> {
    private final String TAG = HomeItemThreeHolder.class.getSimpleName();
    ...
    public HomeItemThreeHolder(ViewGroup parent) {
