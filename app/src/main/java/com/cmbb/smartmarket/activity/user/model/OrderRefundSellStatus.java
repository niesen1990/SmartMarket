...
public enum OrderRefundSellStatus {
    ...
    买家申请退款("APPLY", "退款详情", "拒绝", "同意"),
    等待买家发货("SENDING", "", "", "提醒退货"),
    等待卖家收货("WAIT_RECEIVE", "", "", "确认收货"),
    退款处理中("REFUNDING", "", "", ""),
    卖家拒绝退款("REJECT", "", "", "拒绝原因"),
    退款完成("REFUNDED", "", "", "");
    ...
    OrderRefundSellStatus(String status, String operationLeft, String operationMid, String operationRight) {
        this.status = status;
    ...
    public static String[] getStatus(String status) {
        ...
        for (OrderRefundSellStatus s : OrderRefundSellStatus.values()) {
