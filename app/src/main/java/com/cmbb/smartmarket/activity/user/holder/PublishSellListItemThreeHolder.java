 ...
 */
public class PublishSellListItemThreeHolder extends BaseViewHolder<MyselfProductPublicListResponseModel.DataEntity.ContentEntity> {
    private final String TAG = PublishSellListItemThreeHolder.class.getSimpleName();
    ...
    public PublishSellListItemThreeHolder(ViewGroup parent) {
