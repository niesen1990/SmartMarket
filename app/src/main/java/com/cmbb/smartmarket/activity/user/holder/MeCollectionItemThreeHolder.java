 ...
 */
public class MeCollectionItemThreeHolder extends BaseViewHolder<MyselfProductCollectListResponseModel.DataEntity.ContentEntity> {
    private final String TAG = MeCollectionItemThreeHolder.class.getSimpleName();
    ...
    public MeCollectionItemThreeHolder(ViewGroup parent) {
