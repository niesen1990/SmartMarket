 ...
 */
public class PublishListItemHolder extends BaseViewHolder<MyselfProductPublicListResponseModel.DataEntity.ContentEntity> {
    private final String TAG = PublishListItemHolder.class.getSimpleName();
    ...
    public PublishListItemHolder(ViewGroup parent) {
        super(parent, R.layout.activity_publish_list_item);
