 ...
 */
public class PublishSellListItemOneHolder extends BaseViewHolder<MyselfProductPublicListResponseModel.DataEntity.ContentEntity> {
    private final String TAG = PublishSellListItemOneHolder.class.getSimpleName();
    ...
    public PublishSellListItemOneHolder(ViewGroup parent) {
