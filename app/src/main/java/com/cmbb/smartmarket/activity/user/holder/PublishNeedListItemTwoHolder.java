 ...
 */
public class PublishNeedListItemTwoHolder extends BaseViewHolder<MyselfProductPublicListResponseModel.DataEntity.ContentEntity> {
    private final String TAG = PublishNeedListItemTwoHolder.class.getSimpleName();
    ...
    public PublishNeedListItemTwoHolder(ViewGroup parent) {
