package com.cmbb.smartmarket.utils.lbs;
...
public class BaiduLocation {
    ...
    public BDLocationListener myListener = new SmartLocationListener();
    ...
    class SmartLocationListener implements BDLocationListener {
