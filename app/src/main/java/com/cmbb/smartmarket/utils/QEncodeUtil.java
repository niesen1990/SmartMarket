...
public class QEncodeUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String key = "smartkids!@#aeskey";

        String param = "{"
                + " \"cmd\": \"wallet/account/getCash\","
                + " \"parameters\": {"
                + "    \"businessBalance\": 20.00,"
                + "    \"cardType\":\"支付宝\","
                + "     \"cardUsername\":\"刘海波\","
                + "     \"cardCode\":\"18684711120\", "
                + "     \"phone\":\"18684711120\","
                + "     \"password\":\"123123\""
                + " },"
                + " \"token\":\"Y2NjNjEwYjctZjkxMC00MWZkLWFkOGItN2JmZjllN2NjMTll\""
                + " }";
        System.out.println("加密前：" + param);

        String param1 = aesEncrypt(param, key);
        System.out.println("加密后：" + param1);

        String param2 = aesDecrypt(param1, key);
        System.out.println("解密后：" + param2);
    }
