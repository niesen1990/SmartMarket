package com.cmbb.smartkids.recyclerview;
...
import com.cmbb.smartkids.recyclerview.swipe.SwipeRefreshLayout;
...
public class SmartRecyclerView extends FrameLayout {
    ...
    private static class EasyDataObserver extends AdapterDataObserver {
        ...
        public EasyDataObserver(SmartRecyclerView recyclerView, boolean hasProgress) {
